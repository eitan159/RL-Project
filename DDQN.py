...
class DDQN_Net(nn.Module):
    ...
    def __init__(self, state_size, action_size, num_opt, seed):
        ...
        self.fc3 = nn.Linear(120, num_opt ** action_size)
...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed,
        ...
        self.qnetwork_local = DDQN_Net(state_size, action_size, self.num_opt, seed).to(device)
        self.qnetwork_target = DDQN_Net(state_size, action_size, self.num_opt, seed).to(device)
    ...
    def learn(self, experiences, gamma):
        ...
        selected_actions = self.qnetwork_local(next_states).argmax(dim=1, keepdim=True)
        Q_targets_next = self.qnetwork_target(next_states)
        Q_targets_next = torch.gather(Q_targets_next , 1, selected_actions).squeeze()
